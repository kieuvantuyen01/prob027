...
instance là
\[
  6\times3\times(3+1)\times10=720.
\]
Mỗi nhóm easy, medium và hard có sáu cặp $(N,c)$. Mỗi cặp có bốn tầng sinh
dữ liệu và mỗi tầng có 10 lần lặp, nên mỗi nhóm có
$6\times4\times10=240$ instance. Bộ dữ liệu vì vậy cân bằng giữa ba mức.
...
tại. Bộ 720 instance nằm trong \texttt{data/benchmark\_v1} và được sinh bằng:
